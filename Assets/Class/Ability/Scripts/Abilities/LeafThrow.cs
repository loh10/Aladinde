...
public class LeafThrow : Ability
{
    public override void Activate(GameObject user)
    {
        ...
        // Cast a ray that retrieves all objects in the given direction up to 'range', checking all layers.
        RaycastHit2D[] hits = Physics2D.RaycastAll(user.transform.position, direction, range, Physics2D.AllLayers);
